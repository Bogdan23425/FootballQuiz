...
2026-01-07 — устранение белого мигания при навигации между экранами
Запрос: устранить белое мигание (white flash) при переходе между экранами в Jetpack Compose навигации
Сделано: добавлен Surface с fillMaxSize() и цветом из MaterialTheme.colorScheme.background на уровне root в MainActivity, обеспечивающий единый стабильный фон для всех экранов, AnimatedContent теперь анимирует контент поверх этого фона без белого мигания
Статус: ✅
